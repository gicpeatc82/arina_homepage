                            ...
                            <div class="row">
                                <div class="col flex flex-column justify-content-center">
                                    ...
                                    <div class="entry-footer">
                                        <a class="btn gradient-bg" href="https://www.arinamillion.com/arinanew">橋本有菜野球拳</a><br><br><br>
                                    </div><!-- .entry-footer" -->
                                </div><!-- .col -->
                            </div><!-- .container -->
                        </div><!-- .hero-content -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-8 col-lg-7">
                    <header class="entry-header">
                        <h2 class="entry-title">酷紅幣區塊鏈遊戲系列</h2>
                    </header>

                    <div class="entry-content">
                        <p>酷紅幣團隊將為日本頂級偶像女優-橋本有菜打造專屬區塊鏈遊戲，有別於一般手遊或線上遊戲，遊戲中的資產將完全儲存於區塊鏈之中，擁有無法竄改、去中心化、真正由玩家所擁有等特性，在轉讓及跨游續延續使用上更為保值，不會因為伺服器關機就讓玩家了努力付諸流水，第三方開發團隊更能透過自行開發的智能合約利用遊戲資產虛寶延伸新的遊戲，使遊戲資產生命週期不受限制。</p>
                    </div>

                    <footer class="entry-footer">
                        <a href="https://zh.wikipedia.org/wiki/%E5%8C%BA%E5%9D%97%E9%93%BE" class="btn gradient-bg">區塊鏈WIKI</a>
                        <a href="https://zh.wikipedia.org/wiki/%E6%99%BA%E8%83%BD%E5%90%88%E7%BA%A6" class="btn dark">智能合約WIKI</a>
                    </footer>
                </div>
            </div>
        </div>

...
===========================================================*/
function early_access($ty_username,$ty_email,$ty_ETH_Address,$ty_guest_ip,$ty_game)
{	
	global $conn,$prefix;
	...
	$guest_ip = mysqli_real_escape_string($conn,$ty_guest_ip);
	$game = mysqli_real_escape_string($conn,$ty_game);
	...
	{
        //新增資料進資料庫語法
        $sql = "INSERT INTO `arina_universe_user` (`username`, `email`, `eth_address`, `IP`, `game`) VALUES ('$username', '$email', '$ETH_Address', '$guest_ip', '$game');";
...
/*=========================================================
	ChatRoom function
	ChatRoom(string chatname,string conversation,string emoji,string guest_ip);
===========================================================*/
function ChatRoom($ty_chatname,$ty_conversation,$ty_emoji,$ty_guest_ip)
{	
	global $conn,$prefix;
	
	$chatname = mysqli_real_escape_string($conn,$ty_chatname);
	$conversation = mysqli_real_escape_string($conn,$ty_conversation);
	$emoji = mysqli_real_escape_string($conn,$ty_emoji);
	$guest_ip = mysqli_real_escape_string($conn,$ty_guest_ip);
	...
	{
        $sql = "INSERT INTO `arina_chat_room` (`chatname`, `conversation`, `emoji`, `IP`) VALUES ('$chatname', '$conversation', '$emoji', '$guest_ip');";
